	...
	<div class="wrapper">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					<#list menudto as menuDTO>
					<li class="treeview"><a href="#"> <i
							class="${(menuDTO.menuicon)!''}"></i><span>${menuDTO.menuname}</span>
							<span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<#list menuDTO.children as secondItem>
							<li class="active"><a href="${secondItem.menuurl}"
								target="yefan"><i class="fa fa-code text-green"></i>${secondItem.menuname}</a></li>
							</#list>
						</ul></li>
					</#list>
				</ul>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<iframe name="yefan" id="content" width="100%"
					style="min-height: 800px" frameborder="0"
					src="/adminin/adminin.html"> </iframe>
			</section>
			<!-- 主体内容结束 -->
